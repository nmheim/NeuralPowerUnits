...
#gateloss(w2,g2) = mean(abs2, vec(gatednpu(X, [1.0 w2], [1.0,g2])))
# gatednpuloss_zero(w1,w2) = mean(abs2, gatednpu(X, [w1 w2], zeros(2)) .- X[1,:])

# display(gatednpuloss(1.0,1.0,1.0,0.0))
# error()
...
# g2 = 0:0.05:1
# heatmap(g2,w2, (g2,w2)->min(gatednpuloss(1.0,w2,1.0,g2), 4))
# heatmap(g2,w2, (g2,w2)->log10.(gatednpuloss(1.0,w2,1.0,g2)))
# heatmap(g2,g2, (g1,g2)->min(gatednpuloss(1.0,1.0,g1,g2), 4))
