...
\todo{should this be longer? or not a section at all?}
...
\todo{other titles: Discovering the Equations of an Epidemic}
...
\begin{figure}
  ...
  \captionof{figure}{Visualization of the best real NPU. Reading from right
