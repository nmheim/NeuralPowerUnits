...
\begin{abstract}
  ...
  the \emph{Neural Power Unit} (NPU\footnote{Implementation of all used neural arithmetic units: \url{https://github.com/nmheim/NeuralArithmetic.jl} }) that operates on the \emph{full domain of
